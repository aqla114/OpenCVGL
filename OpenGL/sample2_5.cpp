...
void set_texture(){
  char *inputFileNames[3] = {"OpenCV/fruits.jpg", "OpenCV/1.1.2.jpg", "OpenCV/0c59abb0.jpg"};
  for(int i = 0; i < 3; i++){
    ...
    glTexSubImage2D(GL_TEXTURE_2D, 0, 
      (TEXTURE_WIDTH - input.cols) / 2, (TEXTURE_HEIGHT - input.rows) / 2,
      input.cols, input.rows, GL_RGB, GL_UNSIGNED_BYTE, input.data);
  }    
}
